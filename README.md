...
* **[Flewi](https://github.com/ma6di/Flewi-public)**: Developed a full-stack language learning PWA using React and FastAPI, featuring interactive flashcards with text-to-speech, and a community forum. Engineered a scalable backend with PostgreSQL and Redis, implementing secure OAuth authentication and automated databasemigrations. (https://flewi.app)
